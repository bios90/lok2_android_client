...
import com.dimfcompany.akcslclient.base.extensions.getNullableText
import com.dimfcompany.akcslclient.base.extensions.makeTransparentBg
import com.dimfcompany.akcslclient.base.extensions.setTextHtml
...
class BuilderDialogMy()
{
    ...
    {
        vm.ps_to_show_dialog.onNext(this)
    }
}